...
- Dados geográficos (`geobr`) com as coordenadas dos limtes dos municípios do estado do Ceará para juntar a base de `dados` com as variáveis principais:
